...
*/
    register(new Service(self.rpc, new VirtualFileSystem(new LocalFileSystem(self.params.local.share.name, self.params.local.share.path))));
  }
...
*/
    register(new Service(self.rpc, new VirtualFileSystem(new DropboxFileSystem(self.params.local.share.name, self.params.local.share.path))));
  }
}
